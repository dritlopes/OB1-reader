...
text_ids = range(1, 3) # text ids from corpus/stimuli list
trials = []
...
if task_name== 'reading':
    ...
    # input text_ids for texting list of sentences in the corpus # OR just give a list of strings as texts
