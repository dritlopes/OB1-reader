...
* Lopes Rego, J. Snell, & Meeter, M. (2025). What determines where readers fixate next? Leveraging NLP to investigate human cognition. Proceedings of the First Workshop on Gaze Data and Natural Language Processing (in press).  To reproduce experiments from paper: https://github.com/dritlopes/OB1-reader/tree/contextual_semantic_similarity
